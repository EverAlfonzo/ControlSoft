...
public class JDProveedor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jBAgregar.setText("Agregar Proveedor");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTbuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBModificarActionPerformed
        ...
        if(jTableClientes.getSelectedRow()>(-1)){
            ...
            String cod= String.valueOf(jTableClientes.getValueAt(jTableClientes.getSelectedRow(), 0));
                new jDModProveedor(null, true,Control,cod,db).setVisible(true);
    ...
    */
    ...
    private void preparartabla() {
         r=null;
         r=db.Listar("*", "proveedor", " where Nom_proveedor like \"%"+ jTbuscar.getText()+"%\" or Id_proveedor like \"%"+ jTbuscar.getText()+"%\"  or Contacto_proveedor like \"%"+ jTbuscar.getText()+"%\" or "
                 + "Marca_proveedor like \"%"+ jTbuscar.getText()+"%\" or Pais_proveedor like \"%"+ jTbuscar.getText()+"%\" or `E-mail_proveedor` like \"%"+ jTbuscar.getText()+"%\" or Tel_proveedor like \"%"+ jTbuscar.getText()+"%\" or Direc_proveedor like \"%"+ jTbuscar.getText()+"%\" " );
            ...
            m =new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                    "Cod. Proveedor", "Contacto", "Marca", "País","Nombre","Email","Teléfono","Dirección"
                }
            ) {
                boolean[] canEdit = new boolean [] {
