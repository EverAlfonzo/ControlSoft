 ...
 * @author Edgar
 */
public class jDBancos extends javax.swing.JDialog {
    ...
    public jDBancos(java.awt.Frame parent, boolean modal,DBConnect con) {
        super(parent, modal);
        initComponents();
     ...
     private void preparartabla() {
         ...
         r=db.Listar("*", "cliente", "");
            ...
            while(r.next()){
                ...
                fila[2]=r.getString("Direc_cliente");
                fila[3]=r.getString("Tel_cliente");
                fila[4]=r.getString("Direc_env_cliente");
                fila[5]=r.getString("e-mail_cliente");
                fila[6]=r.getString("Contacto_cliente");
                m.addRow(fila);
            }
...
//        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jDBancos dialog = new jDBancos(new javax.swing.JFrame(), true,null);
