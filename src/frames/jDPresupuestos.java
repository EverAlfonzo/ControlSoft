...
public class jDPresupuestos extends javax.swing.JDialog {
   ...
   DateFormat hola;
    ...
    public jDPresupuestos(java.awt.Frame parent, boolean modal,DBConnect con) {
        super(parent, modal);
        initComponents();
        setIconImage(imagen);
    ...
    private void jBNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNuevoActionPerformed
        new jDnPresupuesto(null, true, bd).setVisible(true);
        PrepararTabla();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                jDPresupuestos dialog = new jDPresupuestos(null, true,null);
    ...
    private void PrepararTabla() {
        ...
        m= (new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"Cod. Presupuesto","Fecha","Nom. Cliente"})
             {
